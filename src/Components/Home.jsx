    ...
    <div name="home" className="w-full h-screen  bg-no-repeat  sm:grid-cols-1">
      ...
      <div className="bg-black grid lg:grid-cols-2 gap-4 w-full lg:h-full">
        ...
        >
          ...
          <p className="text-[#8892b0] lg:text-[1rem] xsm:text-[.7rem] lg:py-4 xsm:py-3 max-w-[700px] lg:mx-auto lg:text-left sm:text-center xsm:text-center xsm:mx-5">
        ...
        <div className="lg:col-span-1 sm:flex sm:justify-center sm:items-center xsm:items-center xsm:justify-center xsm:flex">
          <img
            src={hxh}
            alt=""
